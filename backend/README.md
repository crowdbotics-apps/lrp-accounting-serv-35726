...
## Project Structure
    ...
    ├── lrp_accounting_serv_35726  # Django project configurations
...
1. Clone this repo and `cd lrp_accounting_serv_35726`
...
2. Clone this repo and `cd lrp_accounting_serv_35726`
